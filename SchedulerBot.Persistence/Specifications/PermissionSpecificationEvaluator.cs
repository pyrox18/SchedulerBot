...
{
    public class PermissionSpecificationEvaluator
    {
        public static IQueryable<Permission> GetQuery(IQueryable<Permission> inputQuery, ISpecification<Permission> specification)
        {
